...
//SORT SCIENTISTS
QString SCI_ORDER_BY_NAME_ASC = "SELECT * FROM Persons Order By Id ASC";
...
//SORT COMPUTERS
QString COM_ORDER_BY_NAME_ASC = "Select * FROM Computers Order By Id ASC";
...
QString SORT_CONNECTIONS = "select t.id as ID, p.name as pName, c.name as Name "
